...
export const claude: ProviderView = {
  ...
  status: 'ok', dataAsOf: now - 60_000, fromLogs: false, maxPercent: 73, level: 'normal', stale: false,
  limits: [
...
export const codex: ProviderView = {
  ...
  status: 'ok', dataAsOf: now - 3 * 3_600_000, fromLogs: true, maxPercent: 97, level: 'critical', stale: false,
