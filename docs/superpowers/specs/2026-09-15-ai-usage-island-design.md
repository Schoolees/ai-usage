...
- `utilization` unit: percent 0–100 (observed `42.0`, `18.0`, `0.0`), matching the assumed shape. `resets_at` format: ISO 8601 string with microseconds and UTC offset (e.g. `2026-01-05T10:00:00.000000+00:00`), matching the assumed shape.
